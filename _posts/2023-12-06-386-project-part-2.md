...
Next, I want to check how accurate the methods I used from Glickman and Stern's paper are.  Since the whole point of using their work is to estimate team strength before the game, I looked at how it ranks teams based on all the data from 2017 through 2022:
...
Now that I am confident in my main variables, I used a couple of methods to look at the correlation between all my variables.  This is important before doing any sort of modeling in order to avoid problems with multicollinearity.
