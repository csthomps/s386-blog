...
- homewins-awaywins is not extremely correlated with my other variables estimating team strength.  This gives me even more confidence that the methods I use to estimate team strength isn't simply basing off of the number of wins a team has.
